...
_Last auto-sync: **2026-09-13 16:13 UTC** from `https://api.agentnet.ink/share/v1/agpk/sources` · official=20 · other-vendor=0 · live_total=20. Regenerate: `python3 scripts/sync_readme_from_share.py --write` (or GitHub Action `sync-readme-from-share`)._
<!-- AUTO:SYNC_META:END -->
