...
_Last auto-sync: **2026-07-17 14:00 UTC** from `https://api.agentnet.ink/share/v1/agpk/sources` · official=14 · other-vendor=0 · live_total=14. Regenerate: `python3 scripts/sync_readme_from_share.py --write` (or GitHub Action `sync-readme-from-share`)._
<!-- AUTO:SYNC_META:END -->
