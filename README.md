...
| `org.agentnet.edge.siemens-s7-1500` | **1.0.1** | `healthy` | AIAGENTNET LLC | S7-1500 edge: brief USAGE + docs pointers; longform on AGPK-MARKET docs/packages/… | [release](https://github.com/AIAGENTNETLLC/AGPK-MARKET/releases/tag/edge-siemens-s7-1500-v1.0.1) |
...
_Last auto-sync: **2026-07-29 09:06 UTC** from `https://api.agentnet.ink/share/v1/agpk/sources` · official=18 · other-vendor=0 · live_total=18. Regenerate: `python3 scripts/sync_readme_from_share.py --write` (or GitHub Action `sync-readme-from-share`)._
<!-- AUTO:SYNC_META:END -->
