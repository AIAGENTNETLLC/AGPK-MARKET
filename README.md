...
_Last auto-sync: **2026-08-08 02:19 UTC** from `https://api.agentnet.ink/share/v1/agpk/sources` · official=19 · other-vendor=0 · live_total=19. Regenerate: `python3 scripts/sync_readme_from_share.py --write` (or GitHub Action `sync-readme-from-share`)._
<!-- AUTO:SYNC_META:END -->
